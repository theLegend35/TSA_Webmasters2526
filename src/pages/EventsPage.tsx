...
const EventsPage: React.FC = () => {
  ...
  return (
    <div ref={pageRef} className={`ev ${isDark ? 'ev--dark' : ''}`}>
      ...
      >
        {selectedEvent && (
          <div className="ev__modal-content" onClick={(e) => e.stopPropagation()}>
            <button className="ev__modal-close" onClick={() => setSelectedEvent(null)}>✕</button>
            ...
            <div className="ev__detail-grid">
              <div className="ev__detail-box">
                ...
                <p className="ev__detail-value">{formatDateTime(selectedEvent)}</p>
              </div>
              <div className="ev__detail-box">
      ...
      <div className="ev__wrapper">
        ...
        <header ref={heroRef} className="ev__hero">
          ...
          <p className="ev__hero-sub">
            Connect with your neighbors at local events, workshops, and community celebrations.
          </p>
        </header>

        {/* Search */}
        <div ref={searchRef} className="ev__search">
          <svg className="ev__search-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div ref={gridRef} className="ev__grid">
          {filteredActive.length > 0 ? (
            ...
            <div className="ev__empty">
              <svg className="ev__empty-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                <rect x="3" y="4" width="18" height="18" rx="2" ry="2" />
                <line x1="16" y1="2" x2="16" y2="6" />
                <line x1="8" y1="2" x2="8" y2="6" />
                <line x1="3" y1="10" x2="21" y2="10" />
              ...
              <p className="ev__empty-text">Try adjusting your search or filter criteria.</p>
            </div>
          )}
        </div>
